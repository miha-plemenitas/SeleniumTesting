...
public class KeyboardTest extends BaseTest {
    ...
    public void testApplicationUsingKeyboard() {
        ...
        textBoxPage.setFullName("Max Verstappen");
        textBoxPage.setEmail("max.verstappen@gmail.com");
        ...
        Assert.assertTrue(actualAddress.contains("Suite 3400"), "Actual address does not contain Suite 3400");
    }
}
